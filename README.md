...
| Задача                                                      | Описание                                  |
|-------------------------------------------------------------|-------------------------------------------|
| [A. Мониторинг](basicDataStructures/A.js)                   | Транспонирование матрицы                  |
...
| [E. Вставка строк (fast)](strings/EFast.js) | Вставляет подстроки в строку                                                                 |
| [E. Вставка строк (slow)](strings/ESlow.js) | Вставляет подстроки в строку                                                                 |
