...
индекс tail увеличивается на 1. При удалении элемента с конца дека, 
индекс tail уменьшается на 1, причем так как JavaScript не поддерживает 
отрицательные индексы в массиве, при удалении элемента с индексом меньшим 0, 
мы ставим указатель на максимальный индекс массива.
...
Массив из n команд и 2 постоянных строк (количество m и n) можно оценить
сложностью O(n). 
